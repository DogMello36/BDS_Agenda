...
namespace Projeto_Agenda {
    ...
    public partial class DataSetServer : global::System.Data.DataSet {
        ...
        public partial class PessoaDataTable : global::System.Data.TypedTableBase<PessoaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PessoaRow AddPessoaRow(string nome, string Endereço, string cidade, string email, System.DateTime data_nascimento) {
...
namespace Projeto_Agenda.DataSetServerTableAdapters {
    ...
    public partial class PessoaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pessoa] ([nome], [Endereço], [cidade], [email], [data_nascimen" +
                "to]) VALUES (@nome, @Endereço, @cidade, @email, @data_nascimento);\r\nSELECT id, n" +
                "ome, Endereço, cidade, email, data_nascimento FROM Pessoa WHERE (id = SCOPE_IDEN" +
                "TITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Pessoa] SET [nome] = @nome, [Endereço] = @Endereço, [cidade] = @cidade, [email] = @email, [data_nascimento] = @data_nascimento WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_Endereço = 1 AND [Endereço] IS NULL) OR ([Endereço] = @Original_Endereço)) AND ((@IsNull_cidade = 1 AND [cidade] IS NULL) OR ([cidade] = @Original_cidade)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_data_nascimento = 1 AND [data_nascimento] IS NULL) OR ([data_nascimento] = @Original_data_nascimento)));
SELECT id, nome, Endereço, cidade, email, data_nascimento FROM Pessoa WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Projeto_Agenda.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, Endereço, cidade, email, data_nascimento FROM dbo.Pessoa";
        ...
        public virtual int Fill(DataSetServer.PessoaDataTable dataTable) {
        ...
        public virtual DataSetServer.PessoaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetServer.PessoaDataTable dataTable = new DataSetServer.PessoaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetServer.PessoaDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetServer dataSet) {
